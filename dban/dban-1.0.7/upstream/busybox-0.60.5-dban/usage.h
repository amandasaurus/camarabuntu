...
#define dwipe_trivial_usage "dwipe help not available"
#define dwipe_full_usage "dwipe help not available"
#define dwipe_example_usage "dwipe help not available"
